# Journal - Tomiris Narimanova, s330029

## Weeks 1-2 (May 11 - May 24, 2026)

### Activities & Effort

- Set up the local environment and compiled the repository Express.js
- Launched the dependency-cruiser utility to analyze the lib/ folder.
- Collected Fan-in and Fan-out metrics for the main modules of the framework.
