...
| Web Browser Users | Send HTTP/HTTPS requests for page loads and form submissions |
| Admin / DevOps | Deploy and configure the application, manage infrastructure |
...
| Database | PostgreSQL, MongoDB | SQL / NoSQL Queries | Persistent data storage and retrieval |
| Cloud Storage | S3, GCS | File Upload/Download | Binary asset storage (user uploads, media) |
